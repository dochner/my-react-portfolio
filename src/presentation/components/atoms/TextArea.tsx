...
const defaultTextAreaClasses =
  "block w-full p-3 border-gray-300 dark:border-dark-100 placeholder-gray-300 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm rounded-md bg-white dark:bg-dark-50 dark:text-white min-h-20";
